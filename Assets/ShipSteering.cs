...
public class ShipSteering : MonoBehaviour
{
    ...
    void Update()
    {
        // Создать новый поворот, умножив вектор направления
        // джойстика на turnRate, и ограничить величиной
        // 90% от половины круга
        ...
        // Умножить на turnRate, чтобы получить
        // величину поворота
        rotation *= turnRate;
