...
public class AsteroidSpawner : MonoBehaviour
{
    ...
    IEnumerator CreateAsteroids()
    {
        ...
        while (true)
        {
            ...
            // Также дождаться опка обновится физическая подсистема
    ...
    void CreateNewAsteroid()
    {
        ...
        // Массштабировать в соответствии с объектом
    ...
    private void OnDrawGizmosSelected()
    {
        ...
        // Сообщить визуализатору Gizmos, что тот 
        // должен использовать текущие позицию и массштаб
    ...
    {
        // Удалить все имеющиеся в игр астероиды
