...
public class GameManager : Singletone<GameManager>
{
    ...
    // Шаблон космической станции, позиция его создания
    ...
    // Предупреждающая рамка, когда игрок покидает границу
    ...
    // Отображает главное меня в момент запуска игры
    private void Start()
    {
        ShowMainMenu();
    }
    ...
    public void StartGame()
    {
        ...
        // Передать сценарию управления камерой ссылку на новый корабль,
        // за которым она должна следовать
    ...
    // Вызывается на касание кнопки Pause или Unpause
    public void SetPaused(bool paused)
    {
        // Переключиться между интерфейсом паузы и игры
    ...
    public void Update()
    {
        ...
        // завершить игру. Если он внутри сферы уничтожения,
        // но за границами сферы предупреждения, показать
        // предупреждающущю рамку. Если он внутри обоих сфер
        // скрвть рамку.
